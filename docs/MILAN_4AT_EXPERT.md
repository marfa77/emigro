# @milan_4at + @como_4at + @milan_ua_chat + @italia_ru_chat soft expert

Скан `@milan_4at`, `@como_4at`, `@milan_ua_chat` и `@italia_ru_chat` → вопросы → writer + fact-check → ЛС draft-боту. В группы бот **не** пишет.
