...
export const metadata = pageMetadata({
  ...
  description:
    "Политика конфиденциальности Emigro: какие персональные данные собираются, как используются при подборе маршрута ВНЖ, кому передаются и как реализовать права GDPR.",
  path: "/ru/privacy",
});
    ...
    <LegalPage title="Политика конфиденциальности" updated={UPDATED}>
      <LegalSection title="1. Кто мы">
        <p>
          ...
          сервиса подбора маршрутов, новостей и передачи заявок фирмам из справочника.
        </p>
        <p>
      ...
      <LegalSection title="3. Зачем обрабатываем">
        <ul className="list-disc space-y-2 pl-5">
          <li>Показ персонализированного результата wizard и списка фирм из справочника.</li>
          <li>Передача заявки выбранной фирме или внутренней обработке команды Emigro.</li>
      ...
      <LegalSection title="4. Правовые основания">
        <p>
          Обработка основана на исполнении запрошенного вами сервиса (подбор маршрута, заявка к фирме из справочника), законном
