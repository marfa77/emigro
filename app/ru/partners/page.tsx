...
export const metadata = pageMetadata({
  title: "Партнёрам",
  description:
    "Emigro ищет партнёров: иммиграционные юристы, релокационные агентства, бухгалтеры, языковые школы и сервис-провайдеры в Европе.",
  path: "/ru/partners",
});
...
const PARTNER_TYPES = [
  ...
  },
  {
    ...
    text: "NIF/банки, страховки, аренда, няни, переводчики, бухгалтерия, налоговые консультанты.",
  },
  {
    icon: Handshake,
    title: "Образование и язык",
    text: "Школы PT-PT, подготовка к CIPLE/CAPLE, курсы для заявителей на гражданство.",
  },
];
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        ...
        <section className="mt-10">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-slate-700">
            <li>страны и типы услуг (D8, D7, family, гражданство и т.д.);</li>
