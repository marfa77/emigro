...
<p>После обмена: <code>npm run threads:exchange-token -- --code=… --write</code>, затем <code>npm run threads:whoami</code> — хэндл должен совпасть с <code>THREADS_USERNAME</code> (бренд Emigro, не личный профиль).</p>
</body>`;
