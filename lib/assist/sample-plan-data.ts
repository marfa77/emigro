...
export const SAMPLE_PLAN_SECTIONS: SamplePlanSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Почему не D7 Португалии: семья хотела испаноязычную среду и уже имела контракт с испанским работодателем (remote). Португалия осталась запасным коридором на случай отказа.",
    ],
    items: [
