...
const INCOME_THRESHOLDS: Record<string, ThresholdSpec> = {
  ...
  "greece-digital-nomad": {
    ...
    adultAddon: 700,
    childAddon: 525,
    labelRu: "месячный доход digital nomad GR",
  },
  "greece-fip": {
    field: "passive_income_eur",
    solo: 3500,
    adultAddon: 700,
    childAddon: 525,
    labelRu: "пассивный доход FIP",
    savingsAlt: {
      field: "savings_eur",
      solo: 84000,
      adultAddon: 16800,
      childAddon: 12600,
      labelRu: "сбережения FIP",
    },
  },
  "cyprus-digital-nomad": {
    ...
    adultAddon: 700,
    childAddon: 525,
    labelRu: "месячный доход digital nomad CY",
  },
  "cyprus-category-f": {
    field: "passive_income_eur",
    solo: 797,
    adultAddon: 384,
    childAddon: 384,
    labelRu: "пассивный доход Category F",
    savingsAlt: {
      field: "savings_eur",
      solo: 30000,
      adultAddon: 0,
      childAddon: 0,
      labelRu: "сбережения Category F",
    },
  },
  "hungary-white-card": {
    field: "monthly_income_eur",
    ...
    adultAddon: 0,
    childAddon: 0,
    labelRu: "месячный доход White Card HU",
  },
  "malta-nrp": {
    field: "monthly_income_eur",
    solo: 3500,
    adultAddon: 0,
    childAddon: 0,
    labelRu: "месячный доход NRP Мальта (€42k/год)",
  },
  "bulgaria-digital-nomad": {
    field: "monthly_income_eur",
    solo: 2600,
    adultAddon: 0,
    childAddon: 0,
    labelRu: "месячный доход DN Болгария (~€31k/год)",
  },
  "croatia-digital-nomad": {
    ...
    adultAddon: 145,
    childAddon: 145,
    labelRu: "месячный доход DN Хорватия (€3 622,50 + 10% avg net на иждивенца)",
  },
  "slovenia-digital-nomad": {
    ...
    adultAddon: 0,
    childAddon: 0,
    labelRu: "месячные средства DN Словения (~€3 200 = 2× avg net, индексируется)",
  },
  "estonia-digital-nomad": {
    ...
    adultAddon: 0,
    childAddon: 0,
    labelRu: "месячный доход DNV Эстония (€4 500, FAQ: gross; РФ/BY почти закрыты)",
  },
};
