...
const CORRIDOR_PROGRAM_SLUGS: Record<string, readonly string[]> = {
  ...
  "ru-speaking-to-sweden": ["sweden-work-permit", "sweden-eu-blue-card", "sweden-family-reunification"],
  "ru-speaking-to-norway": ["norway-skilled-worker", "norway-eu-blue-card", "norway-family-reunification"],
  "ru-speaking-to-finland": ["finland-work-permit", "finland-startup", "finland-family-reunification"],
  "ru-speaking-to-denmark": ["denmark-work-permit", "denmark-fast-track", "denmark-family-reunification"],
