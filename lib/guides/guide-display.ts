...
export function corridorWizardBlurb(urlSegment: string): string {
  const blurbs: Record<string, string> = {
    ...
    sweden: "Work permit, Blue Card, семья — wizard сопоставит профиль с требованиями.",
    norway: "Skilled worker, Blue Card, семья — wizard сопоставит профиль с требованиями.",
    finland: "Work/specialist, startup, семья — wizard сопоставит профиль с требованиями.",
    denmark: "Pay limit, Fast-track, семья — wizard сопоставит профиль с требованиями.",
