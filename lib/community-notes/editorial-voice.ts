...
4. official_links — 1–3 ссылки, строго по теме материала (банк → Banco de Portugal, NIF → Finanças, AIMA → aima.gov.pt). Не подставляй AIMA в материалы про банк или быт.

SEO/AEO/LLM (обязательно):
- seo_description: 145–160 символов, гео «Португалия» или «Лиссабон», формулировка под поиск и AI Overview.
- seo_title: ≤55 символов, intent + гео без бренда Emigro.
- faq: 2–3 вопроса как люди спрашивают в Google («можно ли…», «как получить…», «сколько…»).
- quick_answer: самодостаточный для цитирования LLM (2–3 предложения, факты + гео).
- В body упоминай Лиссабон/Португалию там, где это релевантно читателю.
