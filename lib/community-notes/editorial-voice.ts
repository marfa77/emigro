 ...
 * 5. PT terms: natural inline with brief Russian gloss in parentheses on first use.
 ...
 *
 * Emigro structure: «Главное:» as a soft closing line; official vs practice; volatile-legal disclaimers.
 * Never skeleton sections with «Что делать:» / «Зачем:» labels — continuous prose only (see EDITORIAL_VOICE_PRACTICAL).
...
/**
 * Leisure / life guides (вино, клубы, еда, фесты, климат, туризм, районы) —
 * Remarque cadence: continuous atmospheric prose. Facts live inside the scene.
 */
export const EDITORIAL_VOICE_LEISURE_REMARQUE = `
РЕДАКЦИОННЫЙ ГОЛОС — «Полный Ремарк» (досуг и жизнь Norte):
Пишите так, будто читатель листает тихую книгу о переезде, а не чеклист.
Ритм Э. М. Ремарка в русском переводе: воздух, усталость, свет, запах, маленькие решения —
без пафоса, без ярлыков, без «Что делать: / Зачем:».

Правила:
- Открывайте сцену: утро, жара, очередь, голод, мост, ночной Uber — затем факты внутри абзаца.
- Абзацы 3–6 предложений; факты (IVDP, €, метро, N222) — как детали мира, не как bullet-дайджест.
- Второе лицо «вы»; редкое «мы»; сухая ирония без стендапа.
- Не дробите смысл ярлыками «Шаг 1», «Ошибка:», «Что делать:», «Зачем:».
- Bullets оставляйте коротко в конце секции (до 5, с глаголом) — они не заменяют прозу.
- Финал секции: «Главное: …» как тихая реплика, не слоган.
- quick_answer — как первая страница главы: сцена + 2 факта, без канцелярита.

АНТИ-ПОВТОР (обязательно — между гайдами и внутри одного гайда):
- Не копируйте чужие лиды и чужие сцены из соседних leisure-гайдов. Каждый гайд — свой вход в мир.
- Внутри гайда не крутите один и тот же оборот в двух секциях подряд (запах, «не открытка», school-run, «в чате уже»).
- Запрещены как штампы (варьируйте смысл другими словами):
  «Утро в X начинается…», «пахнет X и Y», «не открытка», «school-run ещё не сжал улицы»,
  «Вы уже в машине, рюкзак…», «в чате уже…», «не „когда-нибудь в отпуск“»,
  «меньше точек, больше смысла», «тихий спор в машине», «чужой язык фейсконтроля».
- Допустимо повторять факты (цены, минуты, IVDP) — запрещено повторять ритм и образ.
- Перед публикацией сверьте лид нового гайда с лидами wine / clubs / gastro / climate / districts:
  если звучит «как будто тот же авторский приём» — перепишите вход.
`.trim();

/**
 * Practical / housing / bureaucracy — topic-fit expert voice (NOT Remarque leisure).
 * Real estate = seasoned realtor / market briefing. AIMA/bank = calm relocant advisor.
 * Continuous prose, zero telegraphic labels — but no atmospheric novel scenes.
 */
export const EDITORIAL_VOICE_PRACTICAL = `
РЕДАКЦИОННЫЙ ГОЛОС — practical по топику (НЕ «Полный Ремарк»):
Remarque-атмосфера (утро, запах, усталость, «тихая книга») — только для leisure/life.
Для жилья, покупки, аренды, земли, банков, AIMA — голос **эксперта по теме**:
риелтор с рынком, налоговый/банковский разбор, спокойный советник по документам.

Правила:
- Связная проза 2–5 предложений; факты (€, сроки, органы) внутри абзаца.
- Открывайте обзором рынка или ясным принципом сделки — не сценой «пахнет сыростью».
- PT-термин при первом упоминании с русской расшифровкой; дальше чаще русским словом.
- «Главное: …» — одно полное предложение простым русским; без стека жаргона.
- Bullets ≤5 с глаголом — чеклист после прозы.
- Каталоги новостроек: обзор риелтора + таблица + карточки проектов читаемыми абзацами.

Запрещено:
- Ярлыки «Что делать:», «Зачем:», «Зачем вам это сейчас:», «Шаг N —» как скелет.
- Телеграф lepta / «asking ≠ сделка; IVA 6% ≠ …».
- Натягивать Remarque-литературу на CPCV, IMT и прайс T2.

Плохо (телеграф): «Что делать: сверить CPCV → IMT. Главное: asking ≠ сделка.»
Плохо (чужой голос): «Утро в шоуруме пахнет свежей штукатуркой и тревогой…» про налог IMT.
Хорошо: voiceExamples.goodPractical — обзор сделки простым русским, как опытный риелтор.
`.trim();
 ...
 * Leisure: EDITORIAL_VOICE_LEISURE_REMARQUE. Practical: EDITORIAL_VOICE_PRACTICAL.
 */
...
Для гайдов досуга и жизни (вино, клубы, еда, фесты, климат, внутренний туризм, районы Porto/Braga)
дополнительно действует режим «Полный Ремарк» — см. EDITORIAL_VOICE_LEISURE_REMARQUE:
сцена и атмосфера первее чеклиста; логистика внутри прозы.

Для жилья, покупки, аренды, банков, AIMA и прочих practical-гайдов —
см. EDITORIAL_VOICE_PRACTICAL: голос эксперта по топику (риелтор / разбор сделки), НЕ Remarque-роман.
...
Тон и ритм:
- Leisure = Remarque. Practical/жильё = опытный риелтор или спокойный разбор документов — полный русский, без телеграфа и без «пахнет утром».
- Тёплый, уверенный, на «вы»; иногда «мы».
- Бюрократию: цифра/факт → что это значит → кого заденет. Без морализаторства.
- Абзацы 2–5 предложений; не телеграф и не литературная сцена ради сцены.
- PT-термины: при первом упоминании — termo (краткая русская расшифровка); дальше чаще русским.
- «Главное: …» — полное предложение простым русским.

Запрещено:
- Ярлыки «Что делать:», «Зачем:», «Зачем вам это сейчас:» как скелет секции.
...
- Каждая секция (кроме glossary): связная проза (сцена → действие → зачем), не ярлыки «Что делать:» / «Зачем:»; финал «Главное: …».
- Хотя бы одна секция «Пошагово для новичка» (section_kind action_guide) или эквивалент в practice — шаги внутри прозы или глагольных bullets, не «Шаг 1 —» как единственный текст абзаца.
...
- ES-термины: NIE, TIE, empadronamiento, extranjería, cita previa — с краткой расшифровкой в скобках при первом упоминании.
- Связная проза 3–6 предложений; без ярлыков «Что делать:» / «Зачем:» как скелета секции.
- Сухая ирония к cita/extranjería-хаосу — уместна; спам @username и телеграф — нет.
- Структура Emigro: «Главное:» как тихая реплика; Официально / На практике; volatile — disclaimer.
`.trim();
...
export const voiceExamples = {
  ...
  goodPractical: `Перед задатком в Norte обычно три этапа: предварительный договор (CPCV), расчёт налога на покупку (IMT) на Portal das Finanças и нотариальный акт (escritura). Цена в объявлении — не финальный чек: сверху заложите примерно 7–10% на налоги, нотариуса и регистрацию. Новостройка T2 в Porto часто €280–440k, в Braga — €165–260k; банк для нерезидента обычно даёт 60–80% от оценки. Главное: не переводите задаток, пока адвокат не проверил реестр и симуляцию налога.`,
  ...
  badTelegraph: `Что делать: сверить CPCV → IMT → escritura. Зачем: promotor и частник используют одни шаги. Главное: asking ≠ сделка; IVA 6% ≠ отмена IMT; município проверьте до sinal.`,
} as const;
...
Для practical/жилья — сцена сделки, факты внутри прозы (EDITORIAL_VOICE_PRACTICAL).
...
- Каждая секция: связная проза (сцена → действие → зачем); УДАЛИ ярлыки «Что делать:» / «Зачем:» / «Зачем вам это сейчас:»; bullets ≤5 с глаголом; финал «Главное: …» простым русским.
...
Хороший абзац (сделка / жильё):
${voiceExamples.goodPractical}

Плохой абзац (канцелярит):
${voiceExamples.bad}

Плохой абзац (телеграф):
${voiceExamples.badTelegraph}`.trim();
...
- Секции: связная проза + «Главное:»; без ярлыков «Что делать:» / «Зачем:»; practice — полные предложения.
...
ОБЯЗАТЕЛЬНАЯ СТРУКТУРА (не «стена текста», не телеграф):
...
3. body_sections — массив секций с heading (H2) и section_kind: official | practice | gap | glossary | action_guide.
   ...
   - В каждой НЕ-glossary секции: связная проза 3–6 предложений (сцена → действие → смысл); bullets = «Как» — до 5 actionable пунктов с глаголом; финал «Главное: …» простым русским.
   - Запрещены ярлыки «Что делать:», «Зачем:», «Зачем вам это сейчас:» как скелет абзацев.
   - Для guide: 4–6 секций + «Пошагово для новичка» (action_guide) или эквивалент в practice.
...
Пиши editorial-заметку для italy.emigro.online: факты плотные, подача тёплая и личная. Источник — 2–3 анонимизированных темы из сторонних Telegram-чатов (@milanru, @milan_4at, @como_4at, @milan_ua_chat, @italia_ru_chat, @forum_italy, @digital_nomad_Italiya), не пересказ чата. Не цитируй @username, телефоны, имена. Сверяй с Agenzia Entrate, Ministero dell'Interno, Questura, INPS — отдельно практика.
