...
export const CURATED_PRACTICE: Record<string, string[]> = {
  "aima-agora-zapis-2026": [
    formatPracticeBullet({
      ...
      period: "2026",
      claim:
        "портал services.aima.gov.pt для продления просроченных ВНЖ открывают только после e-mail от AIMA с требованием оплатить госпошлину",
      forReader: "без письма форма недоступна — не тратьте время на поиск кнопки на сайте",
    }),
  ...
  "arenda-kvartiry-lisbon-pervyi-mesyac-2026": [
    ...
    "Q2 2026 (@lepta/Idealista): спрос на аренду +36% г/г, конкуренция высокая даже при небольшом снижении средних цен — open house и решение в день просмотра.",
    "Депозит и fiador: на практике просят 2–3 месяца вперёд + caução 1–2 месяца; если нет португальского fiador — предоплата 6–12 мес. или корпоративный договор.",
    "Caução disputes (@chatlisboa, 2026): мелкие удержания → игнор → «ужасное состояние» без inventory — фото при заселении обязательны.",
