...
const bodySections: NoteBodySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: август на побережье = цены ×2, CP переполнен, risco de incêndio (риск пожара) запрещает мангал (@chatlisboa 06.2025).",
    ],
    bullets: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: «дешёвый уикенд» превращается в €300, если забыть portagem (плату за трассу), парковку arrumadores (уличных «парковщиков») (@por_tugal 12.2025) и платный пляжный parking.",
    ],
    bullets: [
