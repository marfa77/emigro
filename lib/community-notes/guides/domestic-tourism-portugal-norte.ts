...
const bodySections: NoteBodySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Alentejo — Évora (UNESCO) и Monsaraz, два–три часа по A1/A6; зимой и весной меньше жары, turismo rural с pool от €60–90 за ночь off-season. Algarve — Faro, Lagos, Sagres: три с половиной часа по A2 или Ryanair OPO→FAR, ориентир €25–80 в одну сторону; в lepta предупреждали про август — толпы, жара, экстремальные температуры. Setúbal и Arrábida — полтора часа, bioluminescence tours (в por_tugal осенью 2025 делились опытом), пляжи без перелёта.",
