...
const bodySections: NoteBodySection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Сайт BY: consulado Paris → декрет 2023: продление за границей закрыто; на деле — возврат в BY или proteção temporária.",
      "Сайт: загран = проездной → с EES (с 2025) RU passaporte не проходит e-gates; только живая очередь.",
    ],
  },
  {
