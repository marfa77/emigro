...
const bodySections: NoteBodySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: без записи в консульство РФ не попасть; готовый passaporte (загранпаспорт) выдают только лично.",
    ],
    bullets: [
      "Запишитесь на lisboa.kdmid.ru: «Первичная запись» → загранпаспорт; детали очереди и подтверждения визита — [запись в консульство](/notes/zapis-v-konsulstvo-portugaliya-2026).",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: ошибка здесь блокирует выезд, банк и продление título de residência (карты ВНЖ).",
    ],
    bullets: [
