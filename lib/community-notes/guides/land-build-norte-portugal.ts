...
const bodySections: NoteBodySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: гостевой дом — не «временная халупа», а легальное habitação (жильё) с licença de utilização (лицензией на проживание); от качества фундамента и вентиляции зависит и основной дом, и будущий AL (краткосрочная аренда).",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: аренда в Porto/Braga €900–1 400/мес. съедает бюджет, если вы недооценили срок licença (лицензии); гостевой сокращает «мёртвое» время, но не отменяет бюрократию.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: «água (вода) есть на карте» и «água у границы участка» — разные бюджеты; servidão (сервитут) без записи в registo (реестре) — повод для соседа закрыть проезд.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: «участок дешёвый» часто компенсируется acesso água/luz (подводом воды/электричества) и reconversão (сменой назначения земли); гостевой не всегда дешевле за m², если нужен качественный фундамент под влажный Norte.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Зачем: humidade (влажность) Norte бьёт по лёгким конструкциям без isolamento (утепления) — см. [климат Norte](/notes/" + NORTE_CLIMATE_SLUG + "); экономия на гостевом оборачивается bolor (плесенью) через два сезона.",
