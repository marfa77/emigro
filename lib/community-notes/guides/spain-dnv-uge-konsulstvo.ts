...
const bodySections: NoteBodySection[] = [
  ...
  },
  {
    ...
    section_kind: "gap",
    bullets: [
      "В чатах релокантов часто пишут «UGE за 2 недели», но официально UGE не заменяет консульскую визу для въезда из third country.",
      "На сайте консульства звучит как полный список документов, а на деле дозапрос перевода jurado типичен.",
