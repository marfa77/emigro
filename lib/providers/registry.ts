...
const PROVIDERS: ServiceProvider[] = [
  ...
  },
  {
    ...
    taglineRu: "Иммиграционное право в Португалии",
    descriptionRu:
      "Иммиграционная фирма Cleber Chagas в Лиссабоне: визы D1–D8, Golden Visa, гражданство и налоговое сопровождение. Сам основатель — иммигрант, поэтому команда хорошо понимает типичные сложности переезда.",
  ...
  },
  {
    ...
    taglineRu: "Иммиграционное право в Германии",
    descriptionRu:
      "Крупная немецкая фирма с офисами в Берлине, Мюнхене, Франкфурте и других городах: Blue Card, skilled worker, family reunification, Niederlassungserlaubnis и Einbürgerung. Консультации на английском, полное сопровождение до решения Ausländerbehörde.",
  ...
  },
  {
    ...
    descriptionRu:
      "Первая в Нидерландах фирма, специализирующаяся только на иммиграции — с 1982 года в Амстердаме. Highly skilled migrant, EU Blue Card, family reunification, 30%-ruling и обжалование решений IND.",
  ...
  },
  {
    ...
    taglineRu: "Иммиграционное право в Нидерландах",
    descriptionRu:
      "Бутиковая амстердамская фирма по трудовой миграции: highly skilled migrant, EU Blue Card, ICT, recognized sponsor и compliance для работодателей. Один из самых известных IND-специалистов в стране — фиксированные тарифы на типовые кейсы.",
  ...
  },
  {
    ...
    descriptionRu:
      "Стокгольмская фирма Adam M. Lindström (LL.M.): work permit, residence permit, family reunification, appeals и гражданство. Один из ведущих migration lawyers Швеции — сопровождение на английском и других языках.",
  ...
  },
  {
    ...
    descriptionRu:
      "Пражская фирма — один из лидеров Czech immigration law: employee card, Blue Card, long-term и permanent residence, гражданство и корпоративная релокация. Более 9 лет практики, сопровождение в Ministerstvo vnitra и обжалование отказов.",
