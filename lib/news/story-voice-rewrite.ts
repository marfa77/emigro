...
Сохрани ВСЕ факты, имена, цифры, даты. Не добавляй нового.
Обязательно вырежи: параллельные «Если вы уже… / Если планируете…», «убедитесь», «паспорта RU/BY», «действовать имеет смысл сейчас», ярлыки абзацев.
Один практический совет — одной короткой фразой в конце, без парных «если/если».
`
    : "";
