...
const PUBLISHER_LABELS: Record<string, string> = {
  ...
  "imidaily.com": "IMI Daily",
  "getgoldenvisa.com": "Get Golden Visa",
  "globalcitizensolutions.com": "Global Citizen Solutions",
  "portugaldecoded.substack.com": "Portugal Decoded",
  "reuters.com": "Reuters",
