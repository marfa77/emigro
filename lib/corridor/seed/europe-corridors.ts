...
export const EUROPE_CORRIDORS: CorridorSeed[] = [
  ...
  },
  {
    ...
    focusHintRu: "Talent salarié qualifié, VLS-TS visiteur, воссоединение, DELF B2, examen civique, префектура",
    ...
    digest: [
      {
        category: "citizenship",
        titleEn: "Naturalization language (DELF B2)",
        titleRu: "Язык для натурализации (DELF B2)",
        bodyEn: "From 1 Jan 2026: standard naturalization requires 5 years legal residence (2 years for French university graduates) and French B2 — oral and written (DELF/DALF B2 or equivalent).",
        bodyRu: "С 01.01.2026: стандартная натурализация — 5 лет легального проживания (2 года для выпускников французского вуза) и французский B2 — устный и письменный (DELF/DALF B2 или эквивалент).",
        sourceUrl: "https://www.immigration.interieur.gouv.fr",
      },
      {
        category: "exam",
        titleEn: "DELF B2 structure",
        titleRu: "Структура DELF B2",
        bodyEn: "DELF B2 tests comprehension, writing, speaking at upper-intermediate level. Plan 12–18 months from zero for Russian speakers.",
        bodyRu: "DELF B2 проверяет понимание, письмо, говорение на уровне upper-intermediate. С нуля закладывайте 12–18 месяцев.",
        sourceUrl: "https://www.france-education-international.fr/delf-dalf",
      },
      {
        category: "exam",
        titleEn: "Examen civique (from Jan 2026)",
        titleRu: "Examen civique (с 01.01.2026)",
        bodyEn: "Mandatory civic exam for all naturalization applicants from 1 Jan 2026: 40 questions, minimum 32/40 (80%), ~€70, accredited centers.",
        bodyRu: "Обязательный гражданский экзамен для всех заявителей с 01.01.2026: 40 вопросов, минимум 32/40 (80%), ~€70, аккредитованные центры.",
        sourceUrl: "https://www.immigration.interieur.gouv.fr",
      },
      {
        category: "timeline",
        titleEn: "Residence → citizenship",
        titleRu: "ВНЖ → гражданство",
        bodyEn: "Typical: VLS-TS → renewals → 5 years → B2 + examen civique → naturalization dossier (12–24 months processing). Fee €255 from 1 May 2026.",
        bodyRu: "Типично: VLS-TS → продления → 5 лет → B2 + examen civique → досье натурализации (12–24 мес.). Пошлина €255 с 01.05.2026.",
      },
      {
        category: "practical",
  ...
  },
  {
    ...
    audienceEn: "Relocation navigator for Russian-speaking applicants targeting Swedish residency routes.",
    audienceRu: "Навигатор релокации для русскоязычных заявителей с фокусом на маршруты ВНЖ в Швеции.",
    focusHintRu: "Sweden work permit, EU Blue Card, family reunification",
    programIds: ["b0000000-0000-4000-8000-000000000100", "b0000000-0000-4000-8000-000000000101", "b0000000-0000-4000-8000-000000000102"],
    versionIds: ["c0000000-0000-4000-8000-000000000100", "c0000000-0000-4000-8000-000000000101", "c0000000-0000-4000-8000-000000000102"],
    wizardId: "d0000000-0000-4000-8000-000000000030",
    moduleIds: ["e0000000-0000-4000-8000-000000000100", "e0000000-0000-4000-8000-000000000101", "e0000000-0000-4000-8000-000000000102", "e0000000-0000-4000-8000-000000000103"],
    familyQuestionKey: "has_family_in_se",
    wizardIntroRu: "Сопоставим профиль со шведским work permit, EU Blue Card и воссоединением семьи.",
    programs: [
      {
      ...
      {
        slug: "sweden-family-reunification",
        type: "BOND",
        destinationIso2: "SE",
        titleEn: "Sweden Family Reunification",
        titleRu: "Швеция — воссоединение семьи",
        summaryEn: "Join a spouse or family member legally residing in Sweden.",
        summaryRu: "Присоединение к супругу или члену семьи с легальным статусом в Швеции.",
        rule: { and: [{ "==": [{ var: "passport_iso2" }, "RU"] }, { "==": [{ var: "has_family_in_se" }, "yes"] }] },
        requirements: [
          { type: "family", labelEn: "Sponsor in Sweden", labelRu: "Спонсор в Швеции", value: "Spouse, partner, or qualifying family member with legal residence" },
          { type: "income", labelEn: "Maintenance requirement", labelRu: "Требование содержания", value: "Housing and income rules — verify current Migrationsverket thresholds" },
        ],
        costs: [{ labelEn: "Application fees", labelRu: "Сборы за подачу", amount: "SEK fees per applicant — verify Migrationsverket" }],
        timeline: [
          { step: "document_prep", titleEn: "Relationship & housing proof", titleRu: "Родство и жильё", duration: "2–8 weeks" },
          { step: "application", titleEn: "Migrationsverket application", titleRu: "Подача в Migrationsverket", duration: "4–12 months" },
      ...
      {
        slug: "sweden-eu-blue-card",
        type: "LABOR",
        destinationIso2: "SE",
        titleEn: "Sweden EU Blue Card",
        titleRu: "Швеция — EU Blue Card",
        summaryEn: "EU Blue Card for highly qualified employment meeting Swedish salary threshold.",
        summaryRu: "EU Blue Card для высококвалифицированной работы с порогом зарплаты Migrationsverket.",
        rule: {
          and: [
            { "==": [{ var: "passport_iso2" }, "RU"] },
            { "==": [{ var: "has_job_offer" }, "yes"] },
            { ">=": [{ var: "monthly_income_eur" }, 4750] },
          ],
        },
        requirements: [
        ...
        costs: [
          { labelEn: "Application fee", labelRu: "Сбор за подачу", amount: "SEK fees — verify Migrationsverket" },
        ],
        timeline: [
          { step: "document_prep", titleEn: "Degree & contract", titleRu: "Диплом и контракт", duration: "2–6 weeks" },
          { step: "application", titleEn: "Migrationsverket Blue Card", titleRu: "Подача Blue Card", duration: "2–8 months" },
          { step: "residence", titleEn: "Blue Card issuance", titleRu: "Выдача Blue Card", duration: "2–4 weeks after approval" },
        ],
        sources: [
          {
    ...
    digest: [
      {
        category: "citizenship",
        titleEn: "Swedish citizenship timeline",
        titleRu: "Срок гражданства Швеции",
        bodyEn: "Sweden: 8 years habitual residence from 6 Jun 2026 (plus income ~SEK 20k/mo and language/civics). Language tests apply.",
        bodyRu: "Швеция: **8 лет** с 06.06.2026 (+ доход ~SEK 20 000/мес и язык/общество). Нужны языковые экзамены.",
        sourceUrl: "https://www.migrationsverket.se/",
      },
      {
        category: "exam",
        titleEn: "Swedish language",
        titleRu: "Шведский язык",
        bodyEn: "Citizenship requires Swedish language proof (SFI and higher levels / civic knowledge).",
        bodyRu: "Для гражданства нужен шведский (SFI и выше) и знания общества.",
      },
      {
        category: "timeline",
        titleEn: "Work permit → permanent residence",
        titleRu: "Work permit → ПМЖ",
        bodyEn: "Sweden: permanent residence often after ~4 years on work permit. Processing backlogs vary.",
        bodyRu: "Швеция: ПМЖ обычно после ~4 лет work permit. Очереди различаются.",
      },
      {
        category: "practical",
        titleEn: "Personnummer",
        titleRu: "Personnummer",
        bodyEn: "Swedish personnummer is essential for banking, tax, and healthcare.",
        bodyRu: "Personnummer нужен для банка, налогов и healthcare.",
      },
      {
        category: "practical",
        titleEn: "Collective agreements",
        titleRu: "Коллективные договоры",
  ...
  },
  {
    ...
    audienceEn: "Relocation navigator for Russian-speaking applicants targeting Norwegian residency routes.",
    audienceRu: "Навигатор релокации для русскоязычных заявителей с фокусом на маршруты ВНЖ в Норвегии.",
    focusHintRu: "UDI skilled worker, EU Blue Card, family reunification — сверяйте UDI",
    programIds: ["b0000000-0000-4000-8000-000000000103", "b0000000-0000-4000-8000-000000000104", "b0000000-0000-4000-8000-000000000105"],
    versionIds: ["c0000000-0000-4000-8000-000000000103", "c0000000-0000-4000-8000-000000000104", "c0000000-0000-4000-8000-000000000105"],
    wizardId: "d0000000-0000-4000-8000-000000000031",
    moduleIds: ["e0000000-0000-4000-8000-000000000104", "e0000000-0000-4000-8000-000000000105", "e0000000-0000-4000-8000-000000000106", "e0000000-0000-4000-8000-000000000107"],
    familyQuestionKey: "has_family_in_no",
    wizardIntroRu: "Сопоставим профиль с UDI skilled worker, EU Blue Card и воссоединением семьи. Пороги — soft: сверяйте udi.no.",
    programs: [
      {
        slug: "norway-skilled-worker",
        type: "LABOR",
        destinationIso2: "NO",
        titleEn: "Norway Skilled Worker",
        titleRu: "Норвегия — skilled worker",
        summaryEn: "Residence for skilled workers with a Norwegian job offer and relevant education/experience.",
        summaryRu: "ВНЖ для квалифицированных работников с оффером в Норвегии и релевантным образованием/опытом.",
        rule: {
          and: [
            { "==": [{ var: "passport_iso2" }, "RU"] },
            { "==": [{ var: "has_job_offer" }, "yes"] },
            { ">=": [{ var: "monthly_income_eur" }, 3500] },
          ],
        },
        requirements: [
          { type: "income", labelEn: "Salary / collective agreement", labelRu: "Зарплата / тариф", value: "Income per collective agreement or UDI practice — orient soft NOK threshold; сверяйте udi.no" },
          { type: "documents", labelEn: "Job offer + skills", labelRu: "Оффер + квалификация", value: "Relevant education and/or experience matching the role" },
          { type: "documents", labelEn: "Norwegian employer", labelRu: "Работодатель в NO", value: "Offer from employer registered in Norway" },
        ],
        costs: [
          { labelEn: "UDI application fee", labelRu: "Сбор UDI", amount: "NOK fees — verify udi.no" },
        ],
        timeline: [
          { step: "document_prep", titleEn: "Offer & documentation", titleRu: "Оффер и документы", duration: "2–6 weeks" },
          { step: "application", titleEn: "UDI / police application", titleRu: "Подача UDI / полиция", duration: "2–8 months" },
          { step: "residence", titleEn: "Residence card", titleRu: "Карта ВНЖ", duration: "2–6 weeks after approval" },
        ],
        sources: [
          {
            url: "https://www.udi.no/en/want-to-apply/work-immigration/",
            excerpt: "UDI — work immigration / skilled worker. Verify current salary and documentation rules.",
            labelEn: "UDI — work immigration",
            labelRu: "UDI — work immigration",
          },
        ],
      },
      {
        slug: "norway-family-reunification",
        type: "BOND",
        destinationIso2: "NO",
        titleEn: "Norway Family Reunification",
        titleRu: "Норвегия — воссоединение семьи",
        summaryEn: "Join a spouse or family member legally residing in Norway.",
        summaryRu: "Присоединение к супругу или члену семьи с легальным статусом в Норвегии.",
        rule: { and: [{ "==": [{ var: "passport_iso2" }, "RU"] }, { "==": [{ var: "has_family_in_no" }, "yes"] }] },
        requirements: [
          { type: "family", labelEn: "Sponsor in Norway", labelRu: "Спонсор в Норвегии", value: "Spouse, partner, or qualifying family member" },
          { type: "income", labelEn: "Maintenance requirement", labelRu: "Требование содержания", value: "Sponsor income/housing — verify UDI family rules" },
        ],
        costs: [{ labelEn: "Application fees", labelRu: "Сборы за подачу", amount: "NOK fees — verify udi.no" }],
        timeline: [
          { step: "document_prep", titleEn: "Relationship & housing proof", titleRu: "Родство и жильё", duration: "2–8 weeks" },
          { step: "application", titleEn: "UDI family application", titleRu: "Подача UDI (семья)", duration: "4–12 months" },
          { step: "residence", titleEn: "Family residence permit", titleRu: "Семейный ВНЖ", duration: "2–8 weeks" },
        ],
        sources: [
          {
            url: "https://www.udi.no/en/want-to-apply/family-immigration/",
            excerpt: "UDI — family immigration. Verify current requirements.",
            labelEn: "UDI — family",
            labelRu: "UDI — family",
          },
        ],
      ...
      {
        slug: "norway-eu-blue-card",
        type: "LABOR",
        destinationIso2: "NO",
        titleEn: "Norway EU Blue Card",
        titleRu: "Норвегия — EU Blue Card (soft)",
        summaryEn: "Norway is not EU; primary non-EU path is Skilled Worker. Any Blue Card / EEA wording — soft, verify UDI.",
        summaryRu: "NO не в ЕС: основной путь non-EU — Skilled Worker. Blue Card / EEA формулировки — soft, сверяйте UDI.",
        rule: {
          and: [
            { "==": [{ var: "passport_iso2" }, "RU"] },
            { "==": [{ var: "has_job_offer" }, "yes"] },
            { ">=": [{ var: "monthly_income_eur" }, 4500] },
          ],
        },
        requirements: [
          { type: "income", labelEn: "Blue Card salary", labelRu: "Зарплата Blue Card", value: "Soft orient — verify current UDI / EEA Blue Card salary for Norway" },
          { type: "documents", labelEn: "Higher qualification", labelRu: "Высшая квалификация", value: "Recognised higher education or equivalent for the role" },
          { type: "documents", labelEn: "Job offer", labelRu: "Оффер", value: "Binding offer meeting Blue Card criteria" },
        ],
        costs: [{ labelEn: "UDI application fee", labelRu: "Сбор UDI", amount: "NOK fees — verify udi.no" }],
        timeline: [
          { step: "document_prep", titleEn: "Degree & contract", titleRu: "Диплом и контракт", duration: "2–6 weeks" },
          { step: "application", titleEn: "UDI Blue Card filing", titleRu: "Подача Blue Card", duration: "2–8 months" },
          { step: "residence", titleEn: "Blue Card issuance", titleRu: "Выдача Blue Card", duration: "2–6 weeks after approval" },
        ],
        sources: [
          {
            url: "https://www.udi.no/",
            excerpt: "UDI — verify whether EU Blue Card / skilled worker schemes apply to your case.",
            labelEn: "UDI Norway",
            labelRu: "UDI Норвегия",
          },
        ],
      },
    ],
    digest: [
      ...
      {
        category: "exam",
        titleEn: "Norwegian language",
        titleRu: "Норвежский язык",
        bodyEn: "Citizenship and some permits require Norwegian language proof (Norskprøve levels — verify UDI).",
        bodyRu: "Для гражданства и части ВНЖ нужен норвежский (Norskprøve — сверяйте UDI).",
      },
      {
        category: "timeline",
        titleEn: "Work → permanent residence",
        titleRu: "Работа → ПМЖ",
        bodyEn: "Permanent residence depends on continuous legal stay and permit type — verify UDI.",
        bodyRu: "ПМЖ зависит от непрерывного статуса и типа permit — сверяйте UDI.",
      },
      {
        category: "practical",
        titleEn: "D-number / national ID",
        titleRu: "D-номер / ID",
        bodyEn: "Norwegian ID / D-number is needed for banking, tax, and healthcare registration.",
        bodyRu: "Норвежский ID / D-номер нужны для банка, налогов и healthcare.",
      },
    ],
  },
  {
    ...
    audienceEn: "Relocation navigator for Russian-speaking applicants targeting Finnish residency routes.",
    audienceRu: "Навигатор релокации для русскоязычных заявителей с фокусом на маршруты ВНЖ в Финляндии.",
    focusHintRu: "Migri work/specialist, startup residence, family — soft, сверяйте migri.fi",
    programIds: ["b0000000-0000-4000-8000-000000000106", "b0000000-0000-4000-8000-000000000107", "b0000000-0000-4000-8000-000000000108"],
    versionIds: ["c0000000-0000-4000-8000-000000000106", "c0000000-0000-4000-8000-000000000107", "c0000000-0000-4000-8000-000000000108"],
    wizardId: "d0000000-0000-4000-8000-000000000032",
    moduleIds: ["e0000000-0000-4000-8000-000000000108", "e0000000-0000-4000-8000-000000000109", "e0000000-0000-4000-8000-000000000110", "e0000000-0000-4000-8000-000000000111"],
    familyQuestionKey: "has_family_in_fi",
    wizardIntroRu: "Сопоставим профиль с Migri work/specialist, startup residence и воссоединением семьи. Пороги soft — сверяйте migri.fi.",
    programs: [
      {
        slug: "finland-work-permit",
        type: "LABOR",
        destinationIso2: "FI",
        titleEn: "Finland Work / Specialist Permit",
        titleRu: "Финляндия — work / specialist",
        summaryEn: "Residence for employed specialists with a Finnish job offer (Migri work streams — soft thresholds).",
        summaryRu: "ВНЖ для наёмных специалистов с оффером в Финляндии (потоки Migri — soft-пороги).",
        rule: {
          and: [
            { "==": [{ var: "passport_iso2" }, "RU"] },
            { "==": [{ var: "has_job_offer" }, "yes"] },
            { ">=": [{ var: "monthly_income_eur" }, 2800] },
          ],
        },
        requirements: [
          { type: "income", labelEn: "Salary (soft)", labelRu: "Зарплата (soft)", value: "Meet Migri / collective agreement levels for the role — verify migri.fi" },
          { type: "documents", labelEn: "Finnish job offer", labelRu: "Оффер в Финляндии", value: "Employment contract meeting work or specialist residence criteria" },
          { type: "insurance", labelEn: "Health insurance", labelRu: "Медстраховка", value: "Coverage as required for the permit type" },
        ],
        costs: [{ labelEn: "Migri application fee", labelRu: "Сбор Migri", amount: "EUR fees — verify migri.fi" }],
        timeline: [
          { step: "document_prep", titleEn: "Offer & docs", titleRu: "Оффер и документы", duration: "2–6 weeks" },
          { step: "application", titleEn: "Enter Finland / Migri", titleRu: "Подача Migri", duration: "1–6 months" },
          { step: "residence", titleEn: "Residence card", titleRu: "Карта ВНЖ", duration: "2–6 weeks after decision" },
        ],
        sources: [
          {
            url: "https://migri.fi/en/working-in-finland",
            excerpt: "Migri — working in Finland. Verify current work and specialist residence streams.",
            labelEn: "Migri — work",
            labelRu: "Migri — работа",
          },
        ],
      },
      {
        slug: "finland-family-reunification",
        type: "BOND",
        destinationIso2: "FI",
        titleEn: "Finland Family Reunification",
        titleRu: "Финляндия — воссоединение семьи",
        summaryEn: "Join a spouse or family member legally residing in Finland.",
        summaryRu: "Присоединение к супругу или члену семьи с легальным статусом в Финляндии.",
        rule: { and: [{ "==": [{ var: "passport_iso2" }, "RU"] }, { "==": [{ var: "has_family_in_fi" }, "yes"] }] },
        requirements: [
          { type: "family", labelEn: "Sponsor in Finland", labelRu: "Спонсор в Финляндии", value: "Spouse, partner, or qualifying family member" },
          { type: "income", labelEn: "Means of support", labelRu: "Средства содержания", value: "Sponsor income/housing — verify Migri family rules" },
        ],
        costs: [{ labelEn: "Application fees", labelRu: "Сборы за подачу", amount: "EUR fees — verify migri.fi" }],
        timeline: [
          { step: "document_prep", titleEn: "Relationship & housing", titleRu: "Родство и жильё", duration: "2–8 weeks" },
          { step: "application", titleEn: "Migri family application", titleRu: "Подача Migri (семья)", duration: "4–12 months" },
          { step: "residence", titleEn: "Family residence permit", titleRu: "Семейный ВНЖ", duration: "2–8 weeks" },
        ],
        sources: [
          {
            url: "https://migri.fi/en/moving-to-finland-to-be-with-a-family-member",
            excerpt: "Migri — family member residence. Verify current requirements.",
            labelEn: "Migri — family",
            labelRu: "Migri — семья",
          },
        ],
      },
      {
        slug: "finland-startup",
        type: "LABOR",
        destinationIso2: "FI",
        titleEn: "Finland Startup Residence",
        titleRu: "Финляндия — startup residence",
        summaryEn: "Residence for founders with an eligible startup (Business Finland eligibility — soft).",
        summaryRu: "ВНЖ для фаундеров со startup (eligibility Business Finland — soft).",
        rule: {
          and: [
            { "==": [{ var: "passport_iso2" }, "RU"] },
            { ">=": [{ var: "savings_eur" }, 10000] },
          ],
        },
        requirements: [
          { type: "documents", labelEn: "Startup eligibility", labelRu: "Eligibility стартапа", value: "Business Finland positive eligibility statement (soft — verify current process)" },
          { type: "income", labelEn: "Means of support", labelRu: "Средства", value: "Sufficient funds for stay — soft orient; verify migri.fi" },
          { type: "documents", labelEn: "Business plan", labelRu: "Бизнес-план", value: "Scalable startup model accepted under the scheme" },
        ],
        costs: [
          { labelEn: "Migri + BF fees", labelRu: "Сборы Migri / BF", amount: "EUR — verify migri.fi / Business Finland" },
        ],
        timeline: [
          { step: "document_prep", titleEn: "BF eligibility & plan", titleRu: "Eligibility BF и план", duration: "1–3 months" },
          { step: "application", titleEn: "Migri startup residence", titleRu: "Подача startup ВНЖ", duration: "1–4 months" },
          { step: "residence", titleEn: "Residence card", titleRu: "Карта ВНЖ", duration: "2–6 weeks after decision" },
        ],
        sources: [
          {
            url: "https://migri.fi/en/startup-residence-permit",
            excerpt: "Migri — startup residence permit. Soft thresholds — verify current rules.",
            labelEn: "Migri — startup",
            labelRu: "Migri — startup",
          },
        ],
      },
    ],
    digest: [
      ...
      {
        category: "exam",
        titleEn: "Finnish / Swedish language",
        titleRu: "Финский / шведский язык",
        bodyEn: "Citizenship requires Finnish or Swedish language proof at required level.",
        bodyRu: "Для гражданства нужен финский или шведский на требуемом уровне.",
      },
      {
        category: "timeline",
        titleEn: "Work → permanent residence",
        titleRu: "Работа → ПМЖ",
        bodyEn: "Permanent residence after continuous legal stay — verify Migri for your permit type.",
        bodyRu: "ПМЖ после непрерывного легального статуса — сверяйте Migri для вашего типа ВНЖ.",
      },
      {
        category: "practical",
        titleEn: "Personal identity code",
        titleRu: "Henkilötunnus",
        bodyEn: "Finnish personal identity code is required for banking, tax, and public services.",
        bodyRu: "Финский персональный код нужен для банка, налогов и госуслуг.",
      },
    ],
  },
  {
    ...
    audienceEn: "Relocation navigator for Russian-speaking applicants targeting Danish residency routes.",
    audienceRu: "Навигатор релокации для русскоязычных заявителей с фокусом на маршруты ВНЖ в Дании.",
    focusHintRu: "Pay limit scheme, Fast-track, family reunification",
    programIds: ["b0000000-0000-4000-8000-000000000109", "b0000000-0000-4000-8000-000000000110", "b0000000-0000-4000-8000-000000000111"],
    versionIds: ["c0000000-0000-4000-8000-000000000109", "c0000000-0000-4000-8000-000000000110", "c0000000-0000-4000-8000-000000000111"],
    wizardId: "d0000000-0000-4000-8000-000000000033",
    moduleIds: ["e0000000-0000-4000-8000-000000000112", "e0000000-0000-4000-8000-000000000113", "e0000000-0000-4000-8000-000000000114", "e0000000-0000-4000-8000-000000000115"],
    familyQuestionKey: "has_family_in_dk",
    wizardIntroRu: "Сопоставим профиль с датским pay limit, Fast-track и воссоединением семьи.",
    programs: [
      {
      ...
      {
        slug: "denmark-family-reunification",
        type: "BOND",
        destinationIso2: "DK",
        titleEn: "Denmark Family Reunification",
        titleRu: "Дания — воссоединение семьи",
        summaryEn: "Join a spouse or family member legally residing in Denmark.",
        summaryRu: "Присоединение к супругу или члену семьи с легальным статусом в Дании.",
        rule: { and: [{ "==": [{ var: "passport_iso2" }, "RU"] }, { "==": [{ var: "has_family_in_dk" }, "yes"] }] },
        requirements: [
          { type: "family", labelEn: "Sponsor in Denmark", labelRu: "Спонсор в Дании", value: "Spouse, partner, or qualifying family member" },
          { type: "income", labelEn: "Maintenance & housing", labelRu: "Содержание и жильё", value: "SIRI family rules — housing, attachment, and income criteria (verify nyidanmark.dk)" },
        ],
        costs: [{ labelEn: "Application fees", labelRu: "Сборы за подачу", amount: "DKK fees — verify SIRI" }],
        timeline: [
          { step: "document_prep", titleEn: "Relationship & housing proof", titleRu: "Родство и жильё", duration: "2–8 weeks" },
          { step: "application", titleEn: "SIRI family application", titleRu: "Подача SIRI (семья)", duration: "4–12 months" },
          { step: "residence", titleEn: "Family residence permit", titleRu: "Семейный ВНЖ", duration: "2–8 weeks" },
        ],
        sources: [
          {
      ...
      {
        slug: "denmark-fast-track",
        type: "LABOR",
        destinationIso2: "DK",
        titleEn: "Denmark Fast-track Scheme",
        titleRu: "Дания — Fast-track",
        summaryEn: "Work residence via SIRI Fast-track for certified employers (soft — verify nyidanmark.dk).",
        summaryRu: "Рабочий ВНЖ через SIRI Fast-track у сертифицированных работодателей (soft — сверяйте nyidanmark.dk).",
        rule: {
          and: [
            { "==": [{ var: "passport_iso2" }, "RU"] },
            { "==": [{ var: "has_job_offer" }, "yes"] },
            { ">=": [{ var: "annual_salary_eur" }, 50000] },
          ],
        },
        requirements: [
          { type: "documents", labelEn: "Certified employer", labelRu: "Сертифицированный работодатель", value: "Danish employer certified for Fast-track — soft; verify SIRI list" },
          { type: "income", labelEn: "Scheme salary", labelRu: "Зарплата схемы", value: "Meet Fast-track track salary / education criteria — soft orient; verify nyidanmark.dk" },
          { type: "documents", labelEn: "Job offer", labelRu: "Оффер", value: "Contract under Fast-track scheme tracks" },
        ],
        costs: [{ labelEn: "SIRI application fee", labelRu: "Сбор SIRI", amount: "DKK fees — verify SIRI" }],
        timeline: [
          { step: "document_prep", titleEn: "Employer certification & contract", titleRu: "Сертификация работодателя и контракт", duration: "1–4 weeks" },
          { step: "application", titleEn: "SIRI Fast-track", titleRu: "Подача Fast-track", duration: "Often faster than standard — verify SIRI" },
          { step: "residence", titleEn: "Residence permit", titleRu: "ВНЖ", duration: "1–4 weeks after approval" },
        ],
        sources: [
          {
            url: "https://nyidanmark.dk/en-GB/You-want-to-apply/Work/Fast-track-scheme",
            excerpt: "SIRI Fast-track scheme — certified employers. Soft thresholds — verify current tracks.",
            labelEn: "SIRI — Fast-track",
            labelRu: "SIRI — Fast-track",
          },
        ],
      },
    ],
    digest: [
      {
        category: "citizenship",
        titleEn: "Danish citizenship timeline",
        titleRu: "Срок гражданства Дании",
        bodyEn: "Denmark: typically ~9 years legal residence plus language/civics — verify SIRI / Interior.",
        bodyRu: "Дания: обычно ~9 лет легального проживания + язык/общество — сверяйте SIRI.",
        sourceUrl: "https://nyidanmark.dk/",
      },
      {
        category: "exam",
        titleEn: "Danish language",
        titleRu: "Датский язык",
        bodyEn: "Citizenship requires Danish language proof (e.g. Prøve i Dansk 3 / PD3).",
        bodyRu: "Для гражданства нужен датский (например PD3).",
      },
      {
        category: "timeline",
        titleEn: "Work → permanent residence",
        titleRu: "Работа → ПМЖ",
        bodyEn: "Permanent residence depends on scheme and continuous stay — verify SIRI.",
        bodyRu: "ПМЖ зависит от схемы и непрерывного статуса — сверяйте SIRI.",
      },
      {
        category: "practical",
        titleEn: "CPR number",
        titleRu: "CPR",
        bodyEn: "Denmark CPR number is essential for banking, tax, and healthcare.",
        bodyRu: "CPR нужен для банка, налогов и healthcare.",
      },
    ],
  },
