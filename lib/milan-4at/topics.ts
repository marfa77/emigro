...
export const MILAN_4AT_TOPICS: Milan4atTopic[] = [
  ...
  },
  {
    ...
    weight: 28,
    patterns: [/\batm\b|metro\s+milano|trenord|абонемент|tessera\s+atm|проездн/i],
    reply:
      "ATM / Trenord — отдельные тарифные зоны; туристический билет и месячный абонемент живут по-разному. Раньше переплачивали, покупая «на всякий» без зоны проживания. Имеет смысл привязать тариф к фактическому адресу и маршруту на неделю, а не к карте достопримечательностей.",
  },
  {
    id: "piva-inps",
