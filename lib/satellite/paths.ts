...
function onItalySatelliteHost(): boolean {
...
export function italyHubPath(): string {
  return satelliteHubPath("italy");
}

export function italyNotePath(slug: string): string {
  return satelliteNotePath(slug, "italy");
}
