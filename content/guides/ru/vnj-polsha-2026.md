...
| **EU Blue Card** | Диплом + ~€3 020+/мес | **8–18 мес.** (+ биометрия **2–4 мес.**; UoC до 3 мес.) | Да (квалифицированная работа) |
...
**Срок:** **реалистично 2026: 8–15 мес.** (Mazowieckie **12–18+**; по UoC до 3 мес.). Сбор ~PLN 340 + PLN 50.
...
| **Pobyt stały (ПМЖ)** | **5 лет** непрерывного легального pobyt (стандарт); **Karta Polaka** — упрощённая подача на ПМЖ |

### Основания для гражданства (obywatelstwo)

| Основание | Срок проживания до подачи | Примечание |
|-----------|---------------------------|------------|
| **Karta Polaka** | **1 год** непрерывно на **ПМЖ**, полученном по Kartą Polaka | **Не** 3 года — отдельный упрощённый трек |
| **Общее упрощённое (ст. 30)** | **3 года** на **ПМЖ** + доход + жильё | **Без** Karty Polaka |
| **Стандарт** | **10 лет** legal stay + ПМЖ + доход + жильё | Основной путь для большинства |
| **Брак** с гражданином PL | **3+ года** брака + **2 года** на ПМЖ | Отдельное основание |

**Рассмотрение:** wojewoda **15–30 мес.** после подачи (по закону ~3 мес.).
