...
Контент готов как Markdown + YAML frontmatter. Для выкладки на сайт:

1. Таблица `emigro_guides` или расширение digest
2. Маршруты `app/ru/guides/[slug]/page.tsx`
3. Sitemap + Article/FAQ schema
4. Перекрёстные ссылки из коридоров и hub

## Кластер ключевых слов

- куда переехать из россии 2026 / куда валить
- внж португалия d8 d7
- digital nomad европа
- временная защита украинцев внж
- blue card германия
- внж без работы пассивный доход
- воссоединение семьи ес
